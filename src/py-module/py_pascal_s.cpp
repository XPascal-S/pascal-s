...
PYBIND11_MODULE(py_pascal_s, m) {
    ...
    pybind11::enum_<KeywordType>(m, "PascalSKeywordType")
            ...
            .value("Div", KeywordType::Div)
            .value("Mod", KeywordType::Mod)
            .value("And", KeywordType::And)
            .value("Or", KeywordType::Or)
            .value("Not", KeywordType::Not)
    ...
    apply_token_class_property(marker_class)
            .def_readwrite("marker_type", &Marker::marker_type);
